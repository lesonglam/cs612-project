...
class CNNConfig:
    def __init__(
        ...
        self.mean = mean
        self.std = std
        self.pretrained_weights = pretrained_weights  # Set to False to train from scratch
...
if __name__ == "__main__":
   ...
   # Load dataset
    ...
    # Configuration
    model_name = "resnet18" 
    cfg = CNNConfig(model_name=model_name, batch_size=256, epochs=50, pretrained_weights=True)
